/*	BSDI	identd.c,v 2.1 1995/02/03 06:45:54 polk Exp	*/
...
#if defined(IRIX) || defined(SVR4) || defined(NeXT) || defined(__bsdi__)
    ...
    struct in_addr *addr;
{
	...
	if (hp)
		...
		if (comparemem(hp->h_addr_list[i], addr, sizeof(struct in_addr)) == 0)
